      ...
      <Box maxWidth="1220px" m="0 auto" mt="8rem">
        <Box textAlign="center" mb="3rem">
          <Text textAlign="center" mb="4rem">
            &rdquo;What I love about Canvey is the easy way we can collaborate
            even if there is a lot of people involved in the process&rdquo;
          </Text>
