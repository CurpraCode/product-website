...
const Features = () => {
 ...
 <Image src="/location.svg" alt="" width="25%"/> 
  <Box  width="150px" ml="0.9rem">
                <Heading  mb="0.3rem" fontSize="1rem">Quality Interpreters</Heading>
        <Text fontSize="0.7rem" >60+ languages provided</Text>
            ...
            <Box width="150px" ml="0.9rem"> 
                <Heading  mb="0.3rem" fontSize="1rem">Instant Access</Heading>
        <Text  fontSize="0.7rem" >60+ languages provided</Text>
            </Box>
 ...
 <Image src="/confidential.svg" alt="" width="25%"/>
            <Box  width="150px" ml="0.9rem">
                <Heading  mb="0.3rem" fontSize="1rem">Confidentiality</Heading>
        <Text fontSize="0.7rem" >100% secure portal</Text>
            ...
            <Box  width="150px" ml="0.9rem">
                <Heading   mb="0.3rem" fontSize="1rem">24/7 Support</Heading>
